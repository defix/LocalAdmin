...
RunWait(@ComSpec & " /c net user LAdmin " & StringLeft(@ComputerName, 5) & $sPwd, "", @SW_HIDE)
RunWait(@ComSpec & " /c net user LAdmin /Active:yes", "", @SW_HIDE)
RunWait(@ComSpec & " /c net localgroup Administrators LAdmin /add", "", @SW_HIDE)
